...
.ol-wmscapabilities ul.ol-wmsform li.extent input {
  width: calc(60% - 2em);
}
.ol-wmscapabilities ul.ol-wmsform li.extent button {
  width: 2em;
  margin: 0;
  vertical-align: middle;
  float: revert;
}
.ol-wmscapabilities ul.ol-wmsform li.extent button:before {
  content: "M";
}
...
.ol-ext-check input:checked ~ span {
  background-color: currentColor;
}
.ol-ext-check input:checked ~ span:before {
  content: "";
  position: absolute;
  width: .5em;
  height: .8em;
