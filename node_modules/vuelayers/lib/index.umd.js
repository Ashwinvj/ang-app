...
(function (global, factory) {
...
}(this, (function (extent,proj,Units,Feature,Vue,Geometry,Circle,GeometryCollection,LineString,MultiLineString,MultiPoint,MultiPolygon,Point,Polygon,Projection,ol,BaseGeoJSON,MVT,TopoJSON,sphere,Interaction,BaseLayer,loadingstrategy,PluggableMap,Overlay,Source,Circle$1,Fill,Icon,ImageStyle,RegularShape,Stroke,Style,Text,size,tilegrid,TileGrid,Collection,style,XYZSource,TileArcGISRestSource,BingMapsSource,Cluster,condition,interaction,source,Geolocation,Graticule,GroupLayer,HeatmapLayer,ImageLayer,ImageStaticSource,ImageWMS,WMSServerType,control,VectorLayer,Map$1,VectorSource,View,WebGLMap,OSMSource,SelectInteraction,StamenSource,TileLayer,VectorTileLayer,VectorTileSource,TileWMSSource,WMTSSource,WMTSTileGrid) { 'use strict';
	...
	*/
	...
	function get$1(obj, path, defaultValue) {
	  var travel = function travel(regexp) {
	    ...
	    return filter$2(_context6 = String.prototype.split.call(path, regexp)).call(_context6, Boolean).reduce(function (res, key) {
	...
	***************************************************************************** */
	...
	function _iterableToArray(iter) {
	  if (typeof symbol$2 !== "undefined" && getIteratorMethod$1(iter) != null || iter["@@iterator"] != null) return from_1$4(iter);
	}
	...
	var featuresContainer = {
	  ...
	  methods: {
	    ...
	    getFeatures: function getFeatures() {
	      ...
	      return slice$2(_context5 = this.$featuresCollection.getArray()).call(_context5);
	    },
	...
	function multiMergeDescriptors() {
	  ...
	  return slice$2(args).call(args, 1).reduce(function (dest, src, i) {
	...
	var merge$2 = function (left, right, comparefn) {
	...
	var interactionsContainer = {
	  ...
	  methods: {
	    ...
	    getInteractions: function getInteractions() {
	      ...
	      return slice$2(_context2 = this.$interactionsCollection.getArray()).call(_context2);
	    },
	    ...
	    getInteractionById: function getInteractionById(interactionId) {
	      ...
	      return find$2(_context3 = this.$interactionsCollection.getArray()).call(_context3, function (interaction$$1) {
	    ...
	    sortInteractions: function sortInteractions(sorter) {
	      ...
	      sort$2(_context4 = this.$interactionsCollection.getArray()).call(_context4, sorter);
	    },
	...
	var layersContainer = {
	  ...
	  methods: {
	    ...
	    getLayers: function getLayers() {
	      ...
	      return slice$2(_context2 = this.$layersCollection.getArray()).call(_context2);
	    },
	    ...
	    getLayerById: function getLayerById(layerId) {
	      ...
	      return find$2(_context3 = this.$layersCollection.getArray()).call(_context3, function (layer) {
	...
	var overlaysContainer = {
	  ...
	  methods: {
	    ...
	    getOverlays: function getOverlays() {
	      ...
	      return slice$2(_context2 = this.$overlaysCollection.getArray()).call(_context2);
	    },
	    ...
	    getOverlayById: function getOverlayById(overlayId) {
	      ...
	      return find$2(_context3 = this.$overlaysCollection.getArray()).call(_context3, function (overlay) {
	...
	*/
	  ...
	  watch: _objectSpread$f(_objectSpread$f({}, makeWatchers(['keyboardEventTarget', 'loadTilesWhileAnimating', 'loadTilesWhileInteracting', 'moveTolerance', 'pixelRatio', 'renderer', 'maxTilesLoading'], function () {
	    ...
	    defaultControls: {
	      ...
	      handler: function handler(value) {
	        ...
	        slice$2(_context2 = this._controlsCollection.getArray()).call(_context2).forEach(function (control$$1) {
	        ...
	        this._controlsCollection.extend(map$2(_context3 = control.defaults(value).getArray()).call(_context3, function (control$$1) {
	    ...
	    defaultInteractions: {
	      ...
	      handler: function handler(value) {
	        ...
	        slice$2(_context4 = this._interactionsCollection.getArray()).call(_context4).forEach(function (interaction$$1) {
	        ...
	        this._interactionsCollection.extend(map$2(_context5 = interaction.defaults(value).getArray()).call(_context5, function (interaction$$1) {
	          interaction$$1.set('vl_default', true);
	          return interaction$$1;
	        }));

	        console.log(slice$2(_context6 = this._interactionsCollection.getArray()).call(_context6));
	      }
	    },
	    wrapX: function wrapX(value) {
	...
	function _iterableToArrayLimit(arr, i) {
	  var _i = arr && (typeof symbol$2 !== "undefined" && getIteratorMethod$1(arr) || arr["@@iterator"]);
